...
\begin{demonstration}
    \begin{description}
        \item[1.]
            On reprend le raisonnement de la démonstration précédente, mais comme $\varphi$ est non dégénérée, le système d'équations linéaires qui définit $F^\perp$ est de rang $p$,
            donc $\dim F^\perp = n - p$ et $\dim F + \dim F^\perp = n$.
        \item[2.]
...
\begin{corollaire}{}{}
    Soit $E$ un espace vectoriel de dimension finie et $V \subset E$ un sev.
    $$
    E = V \oplus V^\perp
    $$
\end{corollaire}

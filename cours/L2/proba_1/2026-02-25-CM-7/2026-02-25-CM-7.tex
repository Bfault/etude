...
\begin{definition}
    ...
    $$
    \phi(x) = P(Z \leq x) = \int_{-\infty}^x \dfrac{1}{\sqrt{2\pi}} e^{-\dfrac{t^2}{2}} dt \quad \text{pour tout } x \in \R
    $$
\end{definition}
...
\begin{definition}
    ...
    $$
    f_X(x) = \dfrac{1}{b - a} \mathbb{1}_{[a, b]}(x) \quad \text{pour tout } x \in \R
    $$
...
\begin{definition}
    ...
    $$
    f_X(x) = \lambda e^{-\lambda x} \mathbb{1}_{\R_+}(x) \quad \text{pour tout } x \in \R.
    $$

...
\begin{proposition}{}{}
    Soit $(A_0, \ldots, A_n)$ un repère affine de $\E$ de dimension $n$. Alors pour tout $M \in \E$, s'écrit de façon unique sous la forme d'un barycentre $bar((A_i, \alpha_i)_{0 \leq i \leq n})$ avec $\sum_{i=0}^n \alpha_i = 1$.
    Les réels $\alpha_i$ sont appelés les \textbf{coordonnées barycentriques} de $M$.
\end{proposition}

...
\begin{definition}
    Soit $x, m \in \N$ avec $m \neq 0$.
    Un nombre $x$ est dit $m$-parasite si $x \times m = d10^{L - 1} + \dfrac{x - d}{10}$ où $d$ est le chiffre des unités de $x$ et $L$ sa taille (nombre de chiffres).
\end{definition}

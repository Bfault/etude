...
\begin{demonstration}
    ...
    \begin{itemize}
        ...
        \begin{align*}
            ...
            &= \tau_{r+1}^\star(\alpha^\star(\varphi)) \\
            &= \tau_{r+1}^\star(\eps(\alpha) \varphi) \quad \text{(par hypothèse de récurrence)} \\
            &= -\eps(\alpha) \varphi \quad \text{(par le théorème \ref{theoreme:transposition_alternee})} \\
            &= - (-1)^r \varphi \\
            &= (-1)^{r+1} \varphi \\
            &= \eps(\sigma) \varphi
        \end{align*}

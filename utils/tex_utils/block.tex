...
\newtheoremstyle{commentairecompact}  % nom du style
  {0pt}    % espace au-dessus (avant)
  {3pt}    % espace au-dessous (après)
  {}        % corps de texte (police normale)
  {}        % indentation
...
\theoremstyle{commentairecompact}
\newtheorem{_commentaire}{Commentaire}[section]
\newenvironment{commentaire}
  {\begin{quote}\begin{_commentaire}}
  {\end{_commentaire}\end{quote}}
